...
import { MessageCircle, Mail, Phone, ArrowRight, Sparkles, Send, ChevronDown } from 'lucide-react';
  ...
  return (
    <section id="contact" style={{
      ...
      <div style={{
        ...
        {/* Removed WhatsApp Card as requested */}
        ...
        <div 
          ...
          onClick={() => window.open('mailto:menutukocluk@gmail.com', '_blank')}
        >
          <div style={{
        ...
        >
          ...
          <div style={{ width: '100%', position: 'relative' }}>
            <button 
              onClick={(e) => { e.stopPropagation(); setShowPhones(!showPhones); }}
              style={{
                width: '100%', padding: '0.9rem', borderRadius: 14, border: 'none',
            ...
            >
              <Phone size={18} /> Hemen Arayın <ChevronDown size={18} style={{ transform: showPhones ? 'rotate(180deg)' : 'none', transition: 'transform 0.3s' }} />
            </button>
            ...
            {showPhones && (
              <div style={{
                ...
                <a href="tel:+905071932618" style={{
                  textDecoration: 'none', color: '#0f172a', padding: '0.75rem',
                  borderRadius: 8, background: '#f8fafc', fontWeight: 700,
                  display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem'
                }} onClick={e => e.stopPropagation()}>
                  <Phone size={16} color="#7e22ce" /> +90 507 193 26 18
                </a>
                <a href="tel:+905385673696" style={{
                  textDecoration: 'none', color: '#0f172a', padding: '0.75rem',
                  borderRadius: 8, background: '#f8fafc', fontWeight: 700,
                  display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem'
                }} onClick={e => e.stopPropagation()}>
                  <Phone size={16} color="#7e22ce" /> +90 538 567 36 96
                </a>
              </div>
            )}
          </div>
